  ...
  return (
    <div className="p-5 sm:p-8 max-w-5xl">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/deals/new"
          className="inline-flex items-center gap-1.5 bg-[#1d1d1f] text-white px-4 py-2 rounded-full text-[13px] font-medium hover:bg-black active:scale-[0.98] transition-all">
        ...
        {STATS.map((s) => (
          <div key={s.label} className="bg-white rounded-[20px] shadow hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 p-5">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-7 h-7 rounded-[8px] bg-[#f5f5f7] flex items-center justify-center">
                <s.icon className="w-3.5 h-3.5 text-[#6e6e73]" strokeWidth={1.8} />
              </div>
