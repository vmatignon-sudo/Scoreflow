        ...
        {step === 1 && (
          <div>
            ...
            <button
              ...
              className="w-full bg-[#1e40af] text-white py-2.5 rounded-lg font-medium hover:bg-[#1e3a8a] transition-colors disabled:opacity-50"
            >
              Continuer
            </button>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-[#1e40af] text-white py-2.5 rounded-lg font-medium hover:bg-[#1e3a8a] transition-colors disabled:opacity-50"
              >
                Continuer
              </button>
            </div>
