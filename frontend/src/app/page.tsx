        ...
        <div className="max-w-[980px] mx-auto flex items-center justify-between px-5 h-11">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link href="/auth/register"
              className="text-[12px] bg-[#1e40af] text-white px-4 py-1.5 rounded-full hover:bg-[#1e3a8a] active:scale-[0.97] transition-all">
              Commencer
            </Link>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map((f) => (
              <div key={f.title} className="bg-white rounded-[20px] p-7 shadow hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                <div className="w-10 h-10 rounded-[12px] bg-[#1e40af]/[0.08] flex items-center justify-center mb-4">
                  <f.icon className="w-5 h-5 text-[#1e40af]" strokeWidth={1.5} />
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-8">
            {STEPS.map((s) => (
              <div key={s.step} className="text-center sm:text-left">
                <div className="w-12 h-12 rounded-full bg-[#1e40af]/[0.08] flex items-center justify-center mx-auto sm:mx-0 mb-4">
                  <s.icon className="w-5 h-5 text-[#1e40af]" strokeWidth={1.5} />
                </div>
